function Install-SevenZip {
    ...
    Write-Verbose "Installing 7Zip Portable..."
    Write-Verbose "Downloading 7zip 9.20 to extract 7zip 19.00"
    ...
    Write-Verbose "Downloading 7zip 19.00"
...
Export-ModuleMember -Function Install-SevenZip -Verbose:$false
